...
class TestJiraPlugin(asynctest.TestCase):
    ...
    def setUp(self):
        patcher1 = patch('charlesbot_jira.jira.Jira.load_config')
        self.addCleanup(patcher1.stop)
        self.mock_load_config = patcher1.start()

        patcher2 = patch('charlesbot_jira.jira.get_jira_issue_info')
        self.addCleanup(patcher2.stop)
        self.mock_get_jira_issue_info = patcher2.start()

        patcher3 = patch('charlesbot_jira.jira.send_jira_issue_response')  # NOQA
